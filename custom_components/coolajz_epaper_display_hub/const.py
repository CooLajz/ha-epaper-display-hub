...
DEFAULT_AVAILABILITY_GRACE = 2.5
...
DESIRED_REFRESH_INTERVAL_MINUTES = "refresh_interval_minutes"
...
DEFAULT_DESIRED = {
    ...
    DESIRED_REFRESH_INTERVAL_MINUTES: DEFAULT_REFRESH_INTERVAL_MINUTES,
