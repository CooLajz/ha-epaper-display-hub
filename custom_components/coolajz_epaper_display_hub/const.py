...
DEFAULT_SUSPENDED_REFRESH_INTERVAL_MINUTES = 60
MIN_SUSPENDED_REFRESH_INTERVAL_MINUTES = 5
MAX_SUSPENDED_REFRESH_INTERVAL_MINUTES = 300
...
DESIRED_SUSPEND_DISPLAY_REFRESH = "suspend_display_refresh"
...
WIFI_FULL_SCAN_COMMAND_TYPE = "wifi_full_scan"
...
DEFAULT_WAKE_TIME_CORRECTION_SECONDS = 0
MIN_WAKE_TIME_CORRECTION_SECONDS = -60
MAX_WAKE_TIME_CORRECTION_SECONDS = 60
...
DEFAULT_DESIRED = {
    ...
    DESIRED_SUSPEND_DISPLAY_REFRESH: False,
}
